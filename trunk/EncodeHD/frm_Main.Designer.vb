...
Partial Class frm_Main
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbx_ConversionDevice.Items.AddRange(New Object() {"Apple TV", "BlackBerry (8100) Pearl", "BlackBerry (8200) Kickstart", "BlackBerry (8300) Curve", "BlackBerry (8700) Electron", "BlackBerry (8800) Indigo", "BlackBerry (8900) Javelin", "BlackBerry (9000) Bold", "BlackBerry (9500) Storm", "iPhone", "iPod 5G", "iPod Classic", "iPod Nano", "iPod Touch", "Nexus One", "Nokia E71", "Playstation 3", "PSP", "T-Mobile G1", "Western Digital TV", "Youtube HD", "X-Box 360", "Zune", "ZuneHD"})
